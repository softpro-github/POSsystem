<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-ink leading-tight">Edit Supplier</h2>
    </x-slot>
            ...
            <div class="bg-surface-raised border border-border rounded-lg p-6">
                <form method="POST" action="{{ route('suppliers.update', $supplier) }}" class="space-y-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('suppliers.index') }}" class="text-sm text-ink-muted hover:underline">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
